  ...
  const content = (
    <div className="bg-white dark:bg-gray-800/80 rounded-2xl border border-gray-200/80 dark:border-gray-700/50 shadow-sm dark:shadow-none p-4 sm:p-5 flex items-start gap-3 sm:gap-4 transition-all duration-150 hover:shadow-md dark:hover:shadow-black/20 group">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-50">{value}</p>
        {change && (
          <span
      ...
      {href && (
        <svg
          className="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-gray-500 dark:group-hover:text-gray-400 transition-colors shrink-0 mt-0.5 hidden sm:block"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={2}
