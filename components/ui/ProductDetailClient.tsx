            ...
            <div className="flex gap-2 overflow-x-auto scrollbar-hide pb-1">
              {product.media.map((m: any) => (
                ...
                >
                  {m.type === "VIDEO" ? (
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        void refreshPublicMediaUrl(m.id).then(
                          (refreshedUrl) => {
                            if (refreshedUrl) {
                              return;
                            }
                  ...
                  {/* {m.isPrimary && (
                    <span className="absolute bottom-1 right-1 w-2 h-2 rounded-full bg-red-400 ring-1 ring-white" />
                  )} */}
                </button>
              ))}
            </div>
                      ...
                      <InfoRow
                        ...
                        value={
                          <span className="font-mono text-xs">
                            {product.currentOwnership.ownerName}
                          </span>
                        }
                      />
                      <InfoRow
